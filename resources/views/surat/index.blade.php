                                ...
                                <tr class="hover:bg-blue-50/40 transition-all duration-200 group">
                                    ...
                                    <td class="px-8 py-6 text-right">
                                        <div class="flex justify-end gap-2 opacity-30 group-hover:opacity-100 transition-opacity">
                                            ...
                                            {{-- Cetak (Approved Only) --}}
                                            @if($surat->status == 'approved')
                                            <a href="{{ route('surat.print', $surat->id) }}" class="w-9 h-9 bg-slate-100 text-slate-600 rounded-xl flex items-center justify-center hover:bg-emerald-500 hover:text-white transition-all shadow-sm">
