    ...
    <form action="{{ route('penduduk.update', $penduduk->id) }}" method="POST" class="space-y-5">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" name="no_kk" value="{{ $penduduk->no_kk }}"
                    class="w-full border border-slate-300 rounded-lg p-2.5 focus:ring-2 focus:ring-blue-500 outline-none transition" required maxlength="16" placeholder="Masukkan 16 digit No. KK">
            </div>
            ...
            <div>
                ...
                <input type="text" name="nik" value="{{ $penduduk->nik }}"
                    class="w-full border border-slate-300 rounded-lg p-2.5 focus:ring-2 focus:ring-blue-500 outline-none transition" required maxlength="16" placeholder="Masukkan 16 digit NIK">
            </div>
        </div>
        ...
        <div>
            ...
            <input type="text" name="nama" value="{{ $penduduk->nama }}"
                class="w-full border border-slate-300 rounded-lg p-2.5 focus:ring-2 focus:ring-blue-500 outline-none transition" required placeholder="Masukkan Nama Lengkap">
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div>
                ...
                <select name="jenis_kelamin" class="w-full border border-slate-300 rounded-lg p-2.5 focus:ring-2 focus:ring-blue-500 outline-none transition" required>
            ...
            <div>
                ...
                <input type="text" name="tempat_lahir" value="{{ $penduduk->tempat_lahir }}"
                    class="w-full border border-slate-300 rounded-lg p-2.5 focus:ring-2 focus:ring-blue-500 outline-none transition" placeholder="Tempat Lahir">
            </div>
            ...
            <div>
                ...
                <input type="datetime-local" name="tanggal_lahir" value="{{ $penduduk->tanggal_lahir }}"
                    class="w-full border border-slate-300 rounded-lg p-2.5 focus:ring-2 focus:ring-blue-500 outline-none transition" onclick="this.showPicker();">
            </div>
        </div>
        ...
        <div>
            ...
            <textarea name="alamat" class="w-full border border-slate-300 rounded-lg p-2.5 focus:ring-2 focus:ring-blue-500 outline-none transition" rows="2" placeholder="Masukkan Alamat">{{ $penduduk->alamat }}</textarea>
        </div>
        ...
        <div class="grid grid-cols-2 gap-6">
            <div>
                ...
                <input type="text" name="rt" value="{{ $penduduk->rt }}"
                    class="w-full border border-slate-300 rounded-lg p-2.5 focus:ring-2 focus:ring-blue-500 outline-none transition" placeholder="RT">
            </div>
            <div>
                <label class="block mb-1.5 font-semibold text-slate-700">RW</label>
                <input type="text" name="rw" value="{{ $penduduk->rw }}"
                    class="w-full border border-slate-300 rounded-lg p-2.5 focus:ring-2 focus:ring-blue-500 outline-none transition" placeholder="RW">
            </div>
        </div>
        ...
        <div>
            ...
            <select name="agama" class="w-full border border-slate-300 rounded-lg p-2.5 focus:ring-2 focus:ring-blue-500 outline-none transition">
                <option value="">-- Pilih --</option>
        ...
        <div>
            ...
            <select name="hubungan_keluarga" class="w-full border border-slate-300 rounded-lg p-2.5 focus:ring-2 focus:ring-blue-500 outline-none transition">
                <option value="">-- Pilih --</option>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" name="nama_ayah" value="{{ $penduduk->nama_ayah }}" class="w-full border border-slate-300 rounded-lg p-2.5 focus:ring-2 focus:ring-blue-500 outline-none transition" placeholder="Nama Ayah">
            </div>

            {{-- Nama Ibu --}}
            <div>
                <label class="block mb-1.5 font-semibold text-slate-700">Nama Ibu</label>
                <input type="text" name="nama_ibu" value="{{ $penduduk->nama_ibu }}" class="w-full border border-slate-300 rounded-lg p-2.5 focus:ring-2 focus:ring-blue-500 outline-none transition" placeholder="Nama Ibu">
            </div>
        </div>
