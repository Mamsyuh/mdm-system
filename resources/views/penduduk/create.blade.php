...
<div class="max-w-4xl mx-auto bg-white shadow-md rounded-lg p-6 m-3">
    ...
    <form action="{{ route('penduduk.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <textarea name="alamat" class="w-full border rounded p-2" rows="3" placeholder="Masukkan Alamat">{{ old('alamat') }}</textarea>
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="nama_ayah" class="w-full border rounded p-2" placeholder="Masukkan Nama Ayah">{{ old('nama_ayah') }}</input>
        </div>

        <div class="mb-4">
            <label class="block mb-1 font-semibold">Nama Ibu</label>
            <input type="text" name="nama_ibu" class="w-full border rounded p-2" placeholder="Masukkan Nama Ibu">{{ old('nama_ibu') }}</input>
        </div>
