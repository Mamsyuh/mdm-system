...
<head>
    ...
    <title>Tambah KK Baru - Desa Benangin</title>
...
<body class="bg-batik min-h-screen">
    ...
    <header class="bg-gradient-to-r from-amber-900 via-red-900 to-amber-900 text-amber-50 shadow-lg sticky top-0 z-20">
        {{-- ... Kode Header sama dengan index.blade.php ... --}}
    ...
    <div class="flex">
        ...
        <main id="main-content" class="flex-1 p-4 md:p-6 transition-all duration-300">
            ...
            <div class="bg-white rounded-xl shadow-2xl p-6">
                <h2 class="text-2xl font-bold text-gray-800 mb-6 border-b pb-2">Tambah Kartu Keluarga Baru</h2>
                ...
                <form action="{{ route('kk.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="alamat" id="alamat" rows="3" required 
                            ...
                            placeholder="Contoh: Jalan Pahlawan No. 12 Desa Benangin">{{ old('alamat') }}</textarea>
                        @error('alamat')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mt-6 border-t pt-4">
                        <button type="submit" class="bg-amber-600 hover:bg-amber-700 text-white font-bold py-2 px-6 rounded-lg shadow-md transition">
                            <i class="fas fa-save mr-1"></i> Simpan KK
                        </button>
                    </div>
                </form>
            </div>
